...
#if defined(CONFIG_LOGGER_CONFIG_LOG_LEVEL_TRACE) // "A lot of logs to give detailed information"
...
#elif defined(CONFIG_LOGGER_CONFIG_LOG_LEVEL_INFO) // "Log important events"
...
#elif defined(CONFIG_LOGGER_CONFIG_LOG_LEVEL_WARN) // "Log if something unwanted happened but didn't cause a problem"
